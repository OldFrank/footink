...
@interface AvCaptureManager (RecorderDelegate) <AVCamRecorderDelegate>
@end
    ...
    if (self != nil) {
        ...
        void (^deviceConnectedBlock)(NSNotification *) = ^(NSNotification *notification) {
			...
			if (deviceMediaType != nil) {
				for (AVCaptureDeviceInput *input in [avsession inputs])
				{
        ...
        void (^deviceDisconnectedBlock)(NSNotification *) = ^(NSNotification *notification) {
			...
			if ([device hasMediaType:AVMediaTypeAudio]) {
				[avsession removeInput:[weakSelf audioInput]];
				[weakSelf setAudioInput:nil];
			}
			else if ([device hasMediaType:AVMediaTypeVideo]) {
				[avsession removeInput:[weakSelf videoInput]];
...
- (BOOL) setupSession
{
    ...
    AVCamRecorder *newRecorder = [[AVCamRecorder alloc] initWithSession:[self avsession] outputFileURL:outputFileURL];
...
- (void)addVideoPreviewLayer {
	[self setPreviewLayer:[[[AVCaptureVideoPreviewLayer alloc] initWithSession:[self avsession]] autorelease]];
...
#pragma mark -
@implementation AvCaptureManager (RecorderDelegate)
