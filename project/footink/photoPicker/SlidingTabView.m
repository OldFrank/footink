...
- (id) initWithTabCount:(NSUInteger)tabCount withText:(NSMutableArray *)labelText delegate:(NSObject <SlidingTabViewDelegate>*)slidingTabViewDelegate 
{
    if ((self = [super init]))
    {
        // Set the delegate
        _delegate = slidingTabViewDelegate;
        ...
        // Draw our tab!
        _tab = [[SlidingTab alloc] initWithFrame:CGRectMake(-5, 0, buttonWidth+10.0, buttonHeight)];
        ...
        for (NSUInteger i = 0 ; i < tabCount ; i++)
        {
            ...
            NSString *ltext=[labelText objectAtIndex:i];
            UILabel *label = [_delegate labelFor:self atIndex:i atLabel:ltext];
            label.backgroundColor = [UIColor clearColor];
            label.font = [UIFont fontWithName:@"Arial-BoldMT" size:11.0f];
