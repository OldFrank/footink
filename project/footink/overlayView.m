    ...
    if (sourceType == UIImagePickerControllerSourceTypeCamera)
    {
        ...
        if ([[self.imagePickerController.cameraOverlayView subviews] count] == 0)
        {
            ...
            CGRect newFrame = CGRectMake(0.0,
                                         ...
                                         self.tabBarController.view.frame.size.height - 10.0,
                                         CGRectGetWidth(overlayViewFrame),
                                         self.tabBarController.view.frame.size.height + 10.0);
            self.tabBarController.view.frame = newFrame;
            NSLog(@"%f",self.imagePickerController.cameraOverlayView.frame.size.height);
            //[self.imagePickerController.cameraOverlayView addSubview:self.tabBarController.view];
        }
    }
}
